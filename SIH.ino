...
#define FIREBASE_AUTH "Ebcxxxxxxxxxxxxxxxxxxxxxx" 
...
void loop()
{
  ...
  Switch = Firebase.getInt("Beds/Bed1/Switch1");
  ...
  if ((Switch==0 || ir==0 || perc<10) && flag==1)
  {
...
//      Serial.print(pos);
  ...
  else if(flag==0 && (Switch==1 && ir!=0 && perc>=10))
  {
